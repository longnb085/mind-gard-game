      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 flex-1 items-center">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              {loading ? (
                ...
                word.split('').map((letter, idx) => (
                  <div 
                    key={idx} 
                    className="w-10 h-14 border-b-4 border-slate-700 flex items-center justify-center text-3xl font-orbitron font-bold text-white"
                  >
            ...
            {!loading && (
              <div className="flex items-start gap-3 p-4 glass rounded-xl border-l-4 border-indigo-500 mt-6">
